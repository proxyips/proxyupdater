...
var rootCmd = &cobra.Command{
	Use:   "proxyupdater",
	Short: "Public proxies are scraped and updated every 10 min",
	Long: `Public proxies are scraped and updated every 10 min.  
...
func init() {
   ...
   // Here you will define your flags and configuration settings.
	...
	//rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.proxyupdater.yaml)")
